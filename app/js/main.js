...
/* harmony import */ var _components_validateForms_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/validateForms.js */ "./src/js/components/validateForms.js");
...
/* harmony import */ var _components_parallax_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/parallax.js */ "./src/js/components/parallax.js");
...
/* harmony import */ var _components_loadMore_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/loadMore.js */ "./src/js/components/loadMore.js");
...
if (acSelectors.length > 0) {
  const accordion = new accordion_js__WEBPACK_IMPORTED_MODULE_0__('.accordion', {
    duration: 400,
    showMultiple: false,
...
const aosSelectors = document.querySelectorAll('[data-aos]');
if (aosSelectors.length > 0) {
...
let throttleToggleClassOnScroll = (0,_functions_throttle_js__WEBPACK_IMPORTED_MODULE_3__.throttle)(() => {
  toggleClassOnScroll(header, 'header--dark', 20);
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _functions_check_viewport_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../functions/check-viewport.js */ "./src/js/functions/check-viewport.js");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (divs.length != 0 && divs.length > 6) {
    ...
    function getItemsInRow() {
      if ((0,_functions_check_viewport_js__WEBPACK_IMPORTED_MODULE_0__.isDesktop)()) {
        return 3;
      }
      if ((0,_functions_check_viewport_js__WEBPACK_IMPORTED_MODULE_0__.isTablet)()) {
        return 4;
      }
      if ((0,_functions_check_viewport_js__WEBPACK_IMPORTED_MODULE_0__.isMobile)()) {
        return 2;
      }
    }
...
if (rellaxSelectors.length > 0) {
  const rellax = new rellax__WEBPACK_IMPORTED_MODULE_0__('.rellax', {
    center: true
  });
}
...
const smoothScroll = new smooth_scroll__WEBPACK_IMPORTED_MODULE_0__('a[href*="#"]', {
  speed: 300,
  header: '.header'
});
document.addEventListener('DOMContentLoaded', function () {
...
if (swiperSelectors.length > 0) {
  ...
  const projectsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.projects__swiper', {
    slidesPerView: 1,
    spaceBetween: 0,
    loop: true,
    navigation: {
  ...
  const clientsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.clients__swiper', {
    slidesPerView: 1,
    slidesPerGroup: 2,
    spaceBetween: 0,
    loop: true,
...
(0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)('#feedback__form', feedbackRules, feedbackChecks, afterForm);
(0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)('#footer-form', footerRules, footerChecks, afterForm);
(0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)('#entry-form', entryRules, [], afterForm);
